...
public:
  ...
  void stopAutoTuneY();
  bool isAutoTuningY() {
    return yTuningActive;
  }

  void autoTuneLoop();
  // Add to public section:
  void setXSampleTime(int newSampleTime) {
    xPID->SetSampleTime(newSampleTime);
  }
  void setYSampleTime(int newSampleTime) {
    yPID->SetSampleTime(newSampleTime);
  }
  ...
  float PID_Compute();
  void setMotorSpeeds(float *vitesse_gauche, float *vitesse_droite);
  void SetError(float er);
